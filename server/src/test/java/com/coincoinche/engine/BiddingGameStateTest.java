            ...
            List.of(
                ...
                new TestCase(
                    ...
                    new GameStateBidding(
                        p1, Contract.pointsContract(100, Suit.CLUBS).withPlayer(p3), false, false),
                    new ArrayList<>(
                        List.of(
                            BiddingMove.passMove(),
                            BiddingMove.contractMove(Contract.pointsContract(110, Suit.SPADES)),
                ...
                new TestCase(
                    ...
                    new GameStateBidding(
                        p1, Contract.pointsContract(90, Suit.DIAMONDS).withPlayer(p3), true, false),
                    new ArrayList<>(List.of(BiddingMove.passMove(), BiddingMove.surcoincheMove()))),
                new TestCase(
                    "Player has contract - coinched",
                    new GameStateBidding(
                        p1, Contract.capotContract(Suit.HEARTS).withPlayer(p1), true, false),
                    new ArrayList<>(List.of(BiddingMove.passMove(), BiddingMove.surcoincheMove()))),
                new TestCase(
                    "Opponent has contract - not coinched",
                    new GameStateBidding(
                        p2, Contract.pointsContract(80, Suit.HEARTS).withPlayer(p1), false, false),
                    new ArrayList<>(
                        List.of(
                            BiddingMove.passMove(),
